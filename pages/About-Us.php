...
<body>
    <div class="homebar">
        <div class="homebar-left">
            <h3 class="homebartext">MediManage</h3>
            <img class="logo" src="../assets/temp log.jpg" alt="temp logo">
        </div>
        <div class="homebar-right">
    ...
    <div class="body">
        ...
        <img src="../assets/picmid.png" alt="MediManage Pic" class="imgmid">
